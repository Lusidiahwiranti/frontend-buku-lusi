...
export default {
  ...
  methods: {
      search() {
        ...
        axios.get(`http://localhost/buku/selectAnggota-nomor.php${number}`)
            .then(response => {
    ...
    submitForm() {
      if (this.mode === 'tambah') {
        axios.post('http://localhost/buku/insertAnggota.php', this.anggota)
            .then(response => {
        ...
        axios.put('http://localhost/buku/updateAnggota.php' + this.anggota.nomor, this.anggota)
            .then(response => {
              console.log(response.data);
    ...
    hapusAnggota(nomor) {
      axios.delete('http://localhost/buku/deleteAnggota.php' + nomor)
          .then(response => {
            console.log(response.data);
